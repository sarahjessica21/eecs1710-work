...
void setup() {
  ...
  rink = loadImage("documents/processing/exercises/exercise02/hockey_rink.jpeg");
  player = loadImage ("documents/processing/exercises/exercise02/player.png");
  goalie = loadImage ("documents/processing/exercises/exercise02/goalie.png");
...
void draw() {
  bg = loadImage ("documents/processing/exercises/exercise02/hockey_rink2.jpeg");
